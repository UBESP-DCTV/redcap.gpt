...
(For more details on how `{targets}` works see its [manual](https://books.ropensci.org/targets/)).
...
> 
> Make sure to replace /path/to/your/cycle.sh with the actual path to your cycle.sh script.
